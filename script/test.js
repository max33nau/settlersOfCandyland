...
player2 = new PlayerInfo('Lord Licorice', 'rgb(255, 0, 0)','graphics/lordLicorice.png','cupCakesAndSundaes/cupCakeRed.svg','cupCakesAndSundaes/sundeaRed.svg');
player3 = new PlayerInfo('Queen Frostine', 'rgb(0, 0, 255)','graphics/queenFrostine.png','cupCakesAndSundaes/cupCakeBlue.svg','cupCakesAndSundaes/sundeaBlue.svg');
player4 = new PlayerInfo('Gloppy', 'rgb(0, 0, 0)','graphics/gloppy.png','cupCakesAndSundaes/cupCakeBrown.svg','cupCakesAndSundaes/sundeaBrown.svg');
